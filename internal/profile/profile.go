...
## Signal-derived (auto)
<!-- signals:auto -->
Nothing derived yet: this block is regenerated by Claude from get_taste_deltas
(evidence-weighted votes, saves, and listen telemetry). Everything OUTSIDE this
block is human ground truth and is never auto-edited.
<!-- /signals:auto -->
`
